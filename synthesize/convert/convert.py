...
if __name__ == "__main__":
    ...
    delete_path = f"./synthesize/delete/output_en/{args.name}_final.jsonl"
    add_path = f"./synthesize/add/output_en/{args.name}_final.jsonl"
    output_path = f"./synthesize/convert/output_en/{args.name}_final.jsonl"
