...
if __name__ == "__main__":
    ...
    input_path = f"./synthesize/traverse/output_cn/{args.name}_v{args.max_verify_time}.{args.max_traverse_time}.jsonl"
    save_path = f"./synthesize/traverse/output_cn/{args.name}_final.jsonl"
